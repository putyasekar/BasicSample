...
import com.diki.idn.basicsample.common.ProfileViewModel

//ini untuk live data (data)
...
//ini untuk observable (prosesnya)
class ProfileObservableViewModel : ProfileViewModel() {
    ...
    fun onLike() {
        likes.increment()
        notifyPropertyChanged(com.diki.idn.basicsample.BR.popularity)
    }
